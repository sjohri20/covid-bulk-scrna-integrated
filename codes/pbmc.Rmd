---
title: "Inspecting gene expression in platelet cells from PBMC dataset"
output: html_notebook
---

```{r}
library(Seurat)
setwd("C:/Users/HP/Desktop/sem 8/project/covid/code2")

pbmc.dat = Read10X(data.dir = "./filtered_feature_bc_matrix/")
pbmc.ch3 <- CreateSeuratObject(counts = pbmc3.dat, min.cells = 10, min.features = 200)
